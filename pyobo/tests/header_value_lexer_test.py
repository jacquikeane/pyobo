...
from pyobo.obo_lexer import OboLexerBuilder, HeaderValueLexer
from pyobo.tests.base_test_for_lexer import BaseTestForLexer


class HeaderValueLexerTest(BaseTestForLexer, unittest.TestCase):
    ...
    def lexing_module(self):
        return HeaderValueLexer()

    def begin_state(self):
        return OboLexerBuilder.HEADER_VALUE
